...
class _OverloadTasks:
    ...
    def generate_markdown_template(self, content: str):
        ...
        _tos = (
            ...
            "[`topic.yml`](https://github.com/Chiuqyan/arxiv-daily-audio-test/blob/main/database/topic.yml).\n"
        )
        _tos += (
            "> You can also view historical data through the "
            "[storage](https://github.com/Chiuqyan/arxiv-daily-audio-test/blob/main/database/storage).\n"
        )
